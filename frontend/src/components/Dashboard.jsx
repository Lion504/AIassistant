    ...
    <div className="dashboard-grid">
      ...
      <div className="dashboard-column">
        ...
        <div className="widget-card" style={{ borderTop: '4px solid #3b82f6' }}>
          <div className="widget-header">
            <h3><i className="fa fa-graduation-cap" style={{ color: '#3b82f6' }}></i> Study entitlement</h3>
          </div>
          <div className="study-info-row">
            <span><strong>Yongzhi Wang</strong></span>
            <span>2412119</span>
          </div>
          <div className="study-info-row">
          ...
          <div className="study-progress">
            ...
            <div>
              <div style={{ fontSize: '1.2rem', fontWeight: 'bold' }}>91 cr</div>
        ...
        <div className="widget-card">
          <div className="widget-header">
            <h3><i className="fa fa-briefcase"></i> Workspaces</h3>
            <i className="fa fa-refresh" style={{ cursor: 'pointer' }}></i>
          </div>
          <input type="text" placeholder="Search from my workspaces" style={{ marginBottom: '15px', padding: '10px' }} />
      ...
      <div className="dashboard-column">
        ...
        <div className="student-guide-hero">
          ...
          <div style={{ marginTop: '20px', fontWeight: 'bold' }}>students.metropolia.fi</div>
        </div>

        {/* Announcements */}
        <div className="widget-card">
          <div className="widget-header">
            <h3><i className="fa fa-bullhorn"></i> Announcements</h3>
          </div>
          {announcements.map((ann, index) => (
            <div key={index} style={{ marginBottom: '15px', paddingBottom: '15px', borderBottom: '1px solid var(--glass-border)' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--primary-color)', marginBottom: '5px' }}>
                {new Date(ann.date).toLocaleDateString()}
              </div>
              <a href={ann.url} style={{ fontWeight: '500', color: 'var(--text-main)', textDecoration: 'none', display: 'block', marginBottom: '5px' }}>
                {ann.title}
              </a>
          ...
          <button className="action-btn" style={{ background: 'transparent', border: '1px solid var(--primary-color)', color: 'var(--primary-color)' }}>
      ...
      <div className="dashboard-column">
          ...
          <div className="shortcuts-grid">
            {[
              ...
              <div key={i} className="shortcut-item" onClick={item.action}>
                <div className="shortcut-icon" style={item.highlight ? { background: 'var(--primary-color)', color: 'white' } : {}}>
        ...
        {/* Course Feedback */}
        <div className="widget-card" style={{ background: '#1e3a8a', borderColor: '#3b82f6' }}>
          <div className="widget-header" style={{ borderBottomColor: 'rgba(255,255,255,0.2)' }}>
            <h3 style={{ color: 'white' }}><i className="fa fa-pencil" style={{ color: 'white' }}></i> Course feedback</h3>
          </div>
          <p style={{ color: 'rgba(255,255,255,0.8)' }}>Give course feedback.</p>
        </div>

        {/* General Feedback */}
        <div className="widget-card" style={{ background: 'linear-gradient(135deg, #ea580c, #c2410c)' }}>
           <div style={{ display: 'flex', alignItems: 'center', gap: '15px', color: 'white' }}>
             <i className="fa fa-envelope-o" style={{ fontSize: '2rem' }}></i>
             <div>
               <h3 style={{ margin: 0, color: 'white' }}>Give Feedback &gt;&gt;</h3>
               <div style={{ fontSize: '0.9rem', opacity: 0.9 }}>about Metropolia's services</div>
             </div>
           </div>
        </div>
      </div>
